...
{
    public class GetCustomerSubmissionsCommandHandler
        : IRequestHandler<GetCustomerSubmissionsQuery, PaginatedList<CustomerSubmissionDto>>
    {
        private readonly IApplicationDbContext _applicationDbContext;
        private readonly IMapper _mapper;

        public GetCustomerSubmissionsCommandHandler(IApplicationDbContext applicationDbContext, IMapper mapper)
        {
